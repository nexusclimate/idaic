              ...
              >
                <div className="flex flex-row items-stretch h-full w-full">
                  ...
                  <div className="flex flex-col justify-center items-start px-6 py-6 min-w-[140px] max-w-[180px] flex-shrink-0 w-full">
                    <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-1 text-left w-full">{project.title}</h2>
                    <div className="text-xs sm:text-sm text-gray-500 text-left mt-0 w-full">{project.company_name}</div>
                  </div>
                </div>
                {/* Wide horizontal orange bar, centered and spanning most of the card */}
                <div className="flex justify-center w-full">
                  <div className="h-1 bg-orange-500 rounded-full my-4" style={{ width: '90%' }} />
                </div>
