export default function ClimateSolutions() {
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">Climate Solution News</h1>
      <p className="text-base sm:text-lg text-gray-600 mb-4">
        Latest news and updates on climate solutions and innovations.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        <div className="bg-white border rounded-lg p-4 sm:p-6">
          <h3 className="text-lg sm:text-xl font-semibold mb-4">Featured Solutions</h3>
        ...
        <div className="bg-white border rounded-lg p-4 sm:p-6">
          <h3 className="text-lg sm:text-xl font-semibold mb-4">Innovation Spotlight</h3>
          <div className="space-y-4">
