          ...
          {filtered.map((project, idx) => {
            ...
            return (
              <button
                ...
                className={`relative bg-gray-100 p-6 sm:p-8 lg:p-10 flex flex-col rounded-lg transition border-2 focus:outline-none hover:border-orange-200 ${isSelected ? 'border-orange-500 shadow-lg' : 'border-transparent'}`}
                style={{
              ...
              >
                ...
                <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-1">{project.name}</h2>
                <div className="text-xs sm:text-sm text-gray-500 mb-2">{project.company}</div>
            ...
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-4 sm:pl-10 lg:pl-16">
              <DialogPanel className="pointer-events-auto w-screen max-w-sm sm:max-w-md transform transition duration-500 ease-in-out bg-white shadow-xl flex flex-col h-full">
                <div className="px-4 py-4 sm:py-6 sm:px-6 flex items-start justify-between border-b border-gray-200">
                  <DialogTitle className="text-sm sm:text-base font-semibold text-gray-900">{isAdding ? 'Add Project' : 'Project Details'}</DialogTitle>
                  <button
                    type="button"
